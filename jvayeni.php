...
$dbname = "weatherApp"; // Your new database name
...
$sql = "SELECT * FROM weatherTable WHERE city = '$city' AND DATE(date) = CURDATE()";
...
if ($result->num_rows > 0) {
    ...
    $insertSql = "INSERT INTO weatherTable (city, date, temperature, humidity, pressure, wind, description)
